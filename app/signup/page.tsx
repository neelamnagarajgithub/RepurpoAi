    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-background flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl border-border/50">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-muted-foreground">
              Join the future of pharmaceutical intelligence
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="organization"
                  type="text"
                  placeholder="Research Institute / Pharma Co."
        ...
        <p className="text-xs text-center text-muted-foreground mt-6 px-8">
          This platform is designed for authorized pharmaceutical research personnel. Institutional approval may be
          required.
        </p>
      </div>
    </div>
